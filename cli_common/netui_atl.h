...
ND_CONNCLI_API int RloginTrylogin( nd_handle h, int accType, const char *userName, const char *passwd, const char *session_file = NULL, NDUINT32 *accID = NULL);

ND_CONNCLI_API int loginAndCreate( nd_handle h, int accType, const char *userName, const char *passwd, const char *save_session_file = NULL, NDUINT32 *accID = NULL);

ND_CONNCLI_API int redirectServer(nd_handle h, const char *host, int port, const char*session_file);

ND_CONNCLI_API int TryLogin( nd_handle h, int accType, const char *userName, const char *passwd, const char *save_session_file = NULL);

ND_CONNCLI_API int TryRegister( nd_handle h, int accType, const char *userName, const char *passwd, const char *save_session_file = NULL);
