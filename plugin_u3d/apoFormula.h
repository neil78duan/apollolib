...
APOLLO_CLI_API bool apoFormulaNameInit(int id, const char *attrName, const char *attrAlias, const char *formula);
APOLLO_CLI_API void apoFormulaPreParse();
...
APOLLO_CLI_API int apoFromulaGetCalcSort(int outputIds[], int bufsize);
...
APOLLO_CLI_API bool apoAttrForSetValues(void *helper, float value[], int count);
...
APOLLO_CLI_API int apoAttrForGetValues(void *helper, float value[], int count);
...
APOLLO_CLI_API float apoAttrForCalcOne(void *helper, int attrId);

APOLLO_CLI_API bool apoAttrForRun(void *helper, const char *formulaText, float *result);

APOLLO_CLI_API int apoAttrForGetInfections(void *helper, int attrid, int outputIds[], int bufsize);
